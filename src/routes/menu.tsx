  ...
  return (
    <div className="relative min-h-screen font-sans text-fg">
      <div className="pointer-events-none fixed inset-0 -z-[1]">
        <img src="/place/hall.jpg" alt="" className="h-full w-full object-cover opacity-[0.22]" />
      ...
      <main className="relative mx-auto max-w-5xl px-4 pb-28 pt-32 md:px-8 md:pt-36">
        ...
        <figure className="mt-8 overflow-hidden rounded-card border border-[#8aa56a]/35">
          <img
